...
(function() {
    ...
    function setDefaults(connection) {
        ...
        //  docs/language/ (to see list of all supported languages)
        connection.language = 'en';

        //  docs/autoTranslateText/
        ...
        //  docs/dontAttachStream/
        connection.dontAttachStream = false;

        //  docs/dontCaptureUserMedia/
        connection.dontCaptureUserMedia = false;
