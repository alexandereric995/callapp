...
main.querySelector('#continue').onclick = function() {
    ...
    addNewMessage({
        ...
        userinfo: '<img src="http://punsaraautocables.com/wp-content/uploads/2020/06/call.gif">'
    });
...
getElement('.main-input-box textarea').onkeyup = function(e) {
    ...
    addNewMessage({
        ...
        userinfo: getUserinfo(rtcMultiConnection.blobURLs[rtcMultiConnection.userid], 'https://thumbs.gfycat.com/WhirlwindQuarterlyAustraliansilkyterrier-size_restricted.gif'),
